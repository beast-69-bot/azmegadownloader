...
async def help_cmd(_, message):
    await message.reply(
        "🤖 <b>AZ MEGA DOWNLOADER BOT</b>\n"
        "<i>Fast • Secure • Simple</i>\n\n"
        "📌 <b>User Commands</b>\n"
        "━━━━━━━━━━━━━━━\n"
        "🔹 <code>/leech &lt;mega link&gt;</code>\n"
        "  Download & upload MEGA files\n\n"
        "🔹 <code>/cancel &lt;task_id&gt;</code>\n"
        "  Cancel your own running task\n\n"
        "🔹 <code>/settings</code>\n"
        "  Set chat ID, caption & thumbnail\n\n"
        "🔹 <code>/start</code>\n"
        "  Start the bot\n\n"
        "🔹 <code>/ping</code>\n"
        "  Check bot status\n\n"
        ...
        "━━━━━━━━━━━━━━━\n"
        "⚙️ <code>/setlogchannel &lt;channel&gt;</code>\n"
        "  Log users who start the bot\n\n"
        "⚙️ <code>/settaskchannel &lt;channel&gt;</code>\n"
        "  Log leech tasks with user & link\n\n"
        "👑 <code>/addadmin &lt;user&gt;</code>\n"
        "👑 <code>/deladmin &lt;user&gt;</code>\n"
        "👑 <code>/listadmins</code>\n\n"
        "🧠 <code>/bsetting</code>\n"
        "  Verification & support settings panel\n\n"
        "⭐ <code>/setpremium &lt;user&gt; &lt;validity&gt;</code>\n"
